...
Public Class TikSearchNew
    ...
    Private Sub TikSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            FlowUpdt.Dock = DockStyle.None
            GrpSerch.Dock = DockStyle.Fill
            FlowDetls.Dock = DockStyle.None
        End If
    End Sub
#Region "First Tab"
    ...
    Private Sub BckBtn2_Click(sender As Object, e As EventArgs) Handles Btn2Bck.Click
        ...
        FlowUpdt.Visible = False
        GrpSerch.Visible = True
        FlowDetls.Visible = False
...
#Region "Updates Partision"
    Private Sub BtnSubmt_Click(sender As Object, e As EventArgs)
        Dim EsStr As String = ""
    ...
    Private Sub CmbEvent_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    End Sub
    Private Sub GridUpdt_CellClick(sender As Object, e As DataGridViewCellEventArgs)
...
#Region "Esclation Buttons 'Not Used'"
    Private Sub BtnEsc_Click(sender As Object, e As EventArgs)
        ' 289421
        Dim AcbDataTable As New DataTable
        Dim EscTable As New DataTable
        Dim WdysTable As New DataTable
...
EscSec_:
    ...
    End Sub
#End Region
    Private Sub BtnAddEdt_Click(sender As Object, e As EventArgs)
...
#Region "Tool Strip GridUpdate"
    ...
    Private Sub GridTicket_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles GridTicket.CellClick
        FlowUpdt.Dock = DockStyle.None
        GrpSerch.Dock = DockStyle.None
        FlowDetls.Dock = DockStyle.Fill

        FlowUpdt.Visible = False
        GrpSerch.Visible = False
        FlowDetls.Visible = True
    End Sub
